...
gct_file <- "/Users/amethyst/FYP/Data/Lung Cancer/GSE19188_ssGSEA.gct"
...
grouping_file <- "/Users/amethyst/FYP/Data/Lung Cancer/GSE19188/GSE19188_SampleGrouping.tsv"  # Adjust path as necessary
...
ggplot(long_data, aes(x = Group, y = Expression, fill = Group)) +
  ...
  scale_fill_manual(values = c("Normal" = "#BEBEBE",   # Color for Normal
                               "Malignant" = "#F5B7B1")) + # Color for Malignant
  labs(title = "ssGSEA GSE19188",
       x = "Group",
       y = "Expression") +
  theme_minimal() +
  theme(
